...
exports.BaseSlashCreator = void 0;
...
class BaseSlashCreator extends eventemitter3_1.default {
    /** @param opts The options for the creator */
    constructor(opts, requestHandlerOverrides) {
        ...
        this.allowedMentions = (0, util_1.formatAllowedMentions)(this.options.allowedMentions);
     ...
     */
    async registerCommandsIn(commandPath, 
    ...
    withServer(server) {
        ...
        if (this.server.isWebserver) {
            ...
            this.server.handleInteraction((interaction) => this._onInteraction(interaction, null, false, null));
        return this;
    }
    ...
    async syncCommandsIn(guildID, deleteCommands = true) {
        ...
        if (!(0, lodash_isequal_1.default)(updatePayload, commandsPayload)) {
    ...
    async _onRequest(treq, respond, context) {
    ...
    async _onInteraction(interaction, respond, webserverMode, serverContext) {
        ...
        switch (interaction.type) {
            ...
            case constants_1.InteractionType.APPLICATION_COMMAND: {
                ...
                if (!command) {
                  ...
                  `,
                    ...
                    const ctx = new commandContext_1.CommandContext(this, interaction, respond, webserverMode, command.deferEphemeral, !this.options.disableTimeouts, serverContext);
            ...
            case constants_1.InteractionType.MESSAGE_COMPONENT: {
                ...
                if (this._componentCallbacks.size || this.listenerCount('componentInteraction') > 0) {
                    const ctx = new componentContext_1.ComponentContext(this, interaction, respond, !this.options.disableTimeouts, serverContext);
            ...
            case constants_1.InteractionType.APPLICATION_COMMAND_AUTOCOMPLETE: {
                const command = this._getCommandFromInteraction(interaction);
                const ctx = new autocompleteContext_1.AutocompleteContext(this, interaction, respond, serverContext);
            ...
            case constants_1.InteractionType.MODAL_SUBMIT: {
                try {
                    const ctx = new modalInteractionContext_1.ModalInteractionContext(this, interaction, respond, !this.options.disableTimeouts, serverContext);
...
exports.BaseSlashCreator = BaseSlashCreator;
